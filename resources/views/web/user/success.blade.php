    ...
    <div class="row">
        <div class="col-md-6 col-12">
            <div class="sign-success">
                ...
                <h5>Если вы не видите письма по входящих, проверьте папку со спамом, а также другие папки, в которые письмо может попасть. Или <a href="/resend/activation">отправьте письмо повторно</a>.</h5>
            </div>
        </div>
    </div>
</div>
